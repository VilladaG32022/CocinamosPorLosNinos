...
export default function SuccessForm(props) {
  return (
        ...
        <h3 className="validate__card-text">Dentro de unos dias sera informado sobre su postulacion y su aceptacion. Muchas gracias por aportar a Cocinamos por los niños.</h3>
